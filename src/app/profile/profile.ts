...
import {
  faUser, faEnvelope, faCalendarAlt, faChartLine, faTrophy, faFire,
  faCheckCircle, faEdit, faSignOutAlt, faCog, faBell, faPalette,
  faMoon, faSun, faGlassWater, faDumbbell, faBookOpen, faHeart, faCar
...
export class ProfileComponent implements OnInit {
  ...
  defaultProfileImage:string='https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80'
  ...
  // Icons
  icons = {
    user: faUser, envelope: faEnvelope, calendar: faCalendarAlt,
    chart: faChartLine, trophy: faTrophy, fire: faFire,
    check: faCheckCircle, edit: faEdit, logout: faSignOutAlt,
    settings: faCog, bell: faBell, palette: faPalette,
    moon: faMoon, sun: faSun
  };

  iconMap: { [key: string]: any } = {
    'faGlassWater': faGlassWater, 'faDumbbell': faDumbbell,
    'faBookOpen': faBookOpen, 'faHeart': faHeart, 'faCar': faCar
  };
...
loadUserData(): void {
  ...
  calculateStatistics(): void {
    ...
    this.completedHabits = this.habits.filter(habit => 
      habit.progress && habit.progress.some(p => p.done)
    ).length;
